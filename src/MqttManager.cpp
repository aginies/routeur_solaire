...
void MqttManager::sendDiscovery() {
    ...
    publishSensor(_config->equipment_name + " Puissance", "equipment_power", "W", "power", "measurement", "equipment_power");
    publishSensor(_config->equipment_name + " Charge", "equipment_percent", "%", "", "measurement", "equipment_percent");

...
public:
    ...
    static SystemState evaluateState(float espTemp, float ssrTemp, uint32_t lastGoodPoll, bool boostActive, bool forcedWindow, bool nightActive, bool ntpSynced, uint32_t currentEpoch);
